...
public class Problem011 extends AbstractProblem
{
    ...
    {
        setNumber( 11 );
        setDescription( "<html>In the 20×20 grid below, four numbers along a diagonal line<br>"
                + "have been marked in red.<br><br>"
                ...
                + "32 98 81 28 64 23 67 10 <font color=\"red\"><b>26</b></font> 38 40 67 59 54 70 66 18 38 64 70<br>"
                + "67 26 20 68 02 62 12 20 95 <font color=\"red\"><b>63</b></font> 94 39 63 08 40 91 66 49 94 21<br>"
                + "24 55 58 05 66 73 99 26 97 17 <font color=\"red\"><b>78</b></font> 78 96 83 14 88 34 89 63 72<br>"
                + "21 36 23 09 75 00 76 44 20 45 35 <font color=\"red\"><b>14</b></font> 00 61 33 97 34 31 33 95<br>"
                ...
                + "The product of these numbers is 26 × 63 × 78 × 14 = 1788696.<br><br>"
                + "What is the greatest product of four adjacent numbers in any direction<br>"
                + "(up, down, left, right, or diagonally) in the 20×20 grid?</html>" );
    }
    ...
    public String getSolution()
    {
        ...
        for( int i = 0; i < m.length - 4; i++ )
        {
            for( int j = 0; j < m[i].length - 4; j++ )
            {
                product = m[i][j] * m[i + 1][j + 1] * m[i + 2][j + 2]
                        * m[i + 3][j + 3];
                max = Math.max( max, product );
                product = m[i][j + 3] * m[i + 1][j + 2] * m[i + 2][j + 1]
                        * m[i + 3][j];
                max = Math.max( max, product );
            }
        }
