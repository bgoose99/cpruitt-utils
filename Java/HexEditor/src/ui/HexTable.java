...
import data.HexTableModel;

/*******************************************************************************
 * This class is a table used to display hex data.
 * 
 * @see IHexTable
 * @see JTable
 ******************************************************************************/
public class HexTable extends JTable implements IHexTable
{
    public static final String EDIT = "tableEdit";
     ...
     * (non-Javadoc)
     * 
     * @see javautils.hex.IHexTable#find(int, byte)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see javautils.hex.IHexTable#rfind(int, byte)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see javautils.hex.IHexTable#gotoOffset(int)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see javautils.hex.IHexTable#getHexTableModel()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see javautils.hex.IHexTable#addBytes(int)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see javautils.hex.IHexTable#deleteBytes(int)
     */
    @Override
