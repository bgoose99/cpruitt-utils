...
const double CoordConversions::RAD_2_DEG = 180.0 / M_PI;
const double CoordConversions::DEG_2_RAD = M_PI / 180.0;
const double CoordConversions::A         = 6378137.0;
const double CoordConversions::B         = 6356752.3;
const double CoordConversions::F         = 1.0 / 298.257223563;
const double CoordConversions::E2        = 2 * F - F * F;
const double CoordConversions::W         = 0.00007292115856;

/******************************************************************************
 * 
 *****************************************************************************/
Vector3D CoordConversions::convertECFtoECI( const Vector3D &ecf, const double &time )
{
 ...
 * 
 *****************************************************************************/
Vector3D CoordConversions::convertECFtoECIVel( const Vector3D &ecfPos, const Vector3D &ecfVel, const double &time )
{
 ...
 * 
 *****************************************************************************/
Vector3D CoordConversions::convertECFtoECIAcc( const Vector3D &ecfPos, const Vector3D &ecfVel, const Vector3D &ecfAcc, const double &time )
{
 ...
 * 
 *****************************************************************************/
Vector3D CoordConversions::convertECItoECF( const Vector3D &eci, const double &time )
{
 ...
 * 
 *****************************************************************************/
Vector3D CoordConversions::convertECItoECFVel( const Vector3D &eciPos, const Vector3D &eciVel, const double &time )
{
 ...
 * 
 *****************************************************************************/
Vector3D CoordConversions::convertECItoECFAcc( const Vector3D &eciPos, const Vector3D &eciVel, const Vector3D &eciAcc, const double &time )
{
 ...
 * 
 *****************************************************************************/
Vector3D CoordConversions::convertLLAtoECF( const Vector3D &lla )
{
   double lat = lla.X();
   double lon = lla.Y();
   double alt = lla.Z();
 ...
 * 
 *****************************************************************************/
Vector3D CoordConversions::convertECFtoLLA( const Vector3D &ecf )
{
 ...
 * 
 *****************************************************************************/
Vector3D CoordConversions::convertENUtoRAE( const Vector3D &enu )
{
 ...
 * 
 *****************************************************************************/
Vector3D CoordConversions::convertRAEtoENU( const Vector3D &rae )
{
 ...
 * 
 *****************************************************************************/
Vector3D CoordConversions::convertECFtoENU( const Vector3D &ecf, const Vector3D &ref )
{
 ...
 * 
 *****************************************************************************/
Vector3D CoordConversions::convertENUtoECF( const Vector3D &enu, const Vector3D &ref )
{
   Vector3D lla = convertECFtoLLA( ref );
   double sinLat = sin( lla.X() * DEG_2_RAD );
   double cosLat = cos( lla.X() * DEG_2_RAD );
 ...
 * 
 *****************************************************************************/
Vector3D CoordConversions::convertECFtoRAE( const Vector3D &ecf, const Vector3D &ref )
{
 ...
 * 
 *****************************************************************************/
Vector3D CoordConversions::convertRAEtoECF( const Vector3D &rae, const Vector3D &ref )
{
 ...
 * 
 *****************************************************************************/
Vector3D CoordConversions::convertRAEtoPhasedArray( const Vector3D &rae, const Vector3D &boresight )
{
 ...
 * 
 *****************************************************************************/
Vector3D CoordConversions::convertPhasedArraytoRUV( const Vector3D &p )
{
 ...
 * 
 *****************************************************************************/
Vector3D CoordConversions::convertPhasedArraytoRUVVel( const Vector3D &p, const Vector3D &v )
{
 ...
 * 
 *****************************************************************************/
Vector3D CoordConversions::convertPhasedArraytoRAE( const Vector3D &p, const Vector3D &boresight )
{
   double sa = sin( boresight.X() * DEG_2_RAD );
   double ca = cos( boresight.X() * DEG_2_RAD );
   double se = sin( boresight.Y() * DEG_2_RAD );
 ...
 * 
 *****************************************************************************/
Vector3D CoordConversions::convertRUVtoPhasedArray( const Vector3D &ruv )
{
 ...
 * 
 *****************************************************************************/
Vector3D CoordConversions::convertRUVtoPhasedArrayVel( const Vector3D &ruv, const Vector3D &ruvVel )
{
   double w = sqrt( 1.0 - ruv.Y() * ruv.Y() - ruv.Z() * ruv.Z() );
 ...
 * 
 *****************************************************************************/
Vector3D CoordConversions::convertECFtoRUV( const Vector3D &ecf, const Vector3D &ref, const Vector3D &boresight )
{
 ...
 * 
 *****************************************************************************/
Vector3D CoordConversions::convertRUVtoECF( const Vector3D &ruv, const Vector3D &ref, const Vector3D &boresight )
{
 ...
 * 
 *****************************************************************************/
Vector3D CoordConversions::convertECFtoRUVVel( const Vector3D &ecf, const Vector3D &ecfVel, const Vector3D &ref, const Vector3D &boresight )
{
 ...
 * 
 *****************************************************************************/
Vector3D CoordConversions::convertRUVtoECFVel( const Vector3D &ruv, const Vector3D &ruvVel, const Vector3D &ref, const Vector3D &boresight )
{
 ...
 * 
 *****************************************************************************/
Vector3D CoordConversions::convertQuaternionsToEuler( const Vector4D &q )
{
   return Vector3D(
 ...
 * 
 *****************************************************************************/
Vector4D CoordConversions::convertEulerToQuaternions( const Vector3D &e )
{
   return Vector4D(
